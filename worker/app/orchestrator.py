...
def run_investigation(message: dict) -> None:
    ...
    try:
        ...
        t0 = time.time()
        from connectors.registry import get_connectors_for_service
        ...
        from worker.app.hypothesis_ranker import rank_hypotheses
        ...
        from worker.app.llm_client import generate_narrative
        ...
        from worker.app.notifier import publish_sns
        try:
...
def _notify(
    ...
    from worker.app.notifier import publish_sns, send_slack
