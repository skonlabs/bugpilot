...
from backend.app.auth import auth_middleware
from backend.app.api import health, keys, investigations, connectors, webhooks, triggers, history, reports
...
def create_app() -> FastAPI:
    ...
    async def shutdown():
        ...
        from backend.app.database import _pool
        if _pool:
            _pool.closeall()
