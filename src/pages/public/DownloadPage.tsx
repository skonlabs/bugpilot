      ...
      <div className="container">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-12 space-y-6">
            ...
            <p className="text-muted-foreground">After installation, activate BugPilot with your API credentials:</p>
            <CopyBlock text="bugpilot activate --key YOUR_API_KEY --secret YOUR_API_SECRET" />
            <div className="rounded-lg border bg-info/10 p-4 text-sm">
              <p className="font-medium text-info">Where do I find my credentials?</p>
              <p className="mt-1 text-muted-foreground">Your API key is visible in your dashboard under <strong>API Credentials</strong>. Your secret is shown once when generated by your admin. If you've lost it, ask your admin to rotate your credentials.</p>
            </div>
          </div>
          ...
          <div className="mt-12 space-y-4">
            ...
            <CopyBlock text="bugpilot status" />
          </div>
        </div>
      </div>
    </div>
