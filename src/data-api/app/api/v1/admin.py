"""
Admin API (data-api) - organization management, user management, audit logs, connectors.

NOTE: This is the self-hostable data layer. It contains CRUD operations only.
Connector test endpoints (POST /connectors/test, POST /connectors/{id}/test) are
intentionally excluded — those require connector implementations which live in the
...
# ---------------------------------------------------------------------------
# Connectors (CRUD only — no test endpoints)
# ---------------------------------------------------------------------------
